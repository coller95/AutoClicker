...
class Recorder:
    ...
    def _get_key_names(self, key) -> tuple:
        ...
        x11_numpad_map = {
            ...
            65430: ('num_1', 'NUM 1'),
            65456: ('num_0', 'NUM 0'),
            65439: ('num_decimal', 'NUM .'),
            65451: ('num_add', 'NUM +'),
            65453: ('num_subtract', 'NUM -'),
            65450: ('num_multiply', 'NUM *'),
            65455: ('num_divide', 'NUM /'),
            65421: ('num_enter', 'NUM ENTER'),
        }
        
        # Check for X11 numpad keycode
        ...
        try:
            ...
            if char is not None:
                ...
                # Numpad detection (vk=None on Linux means numpad)
                if vk is None:
        ...
        display_map = {
            ...
            'CTRL': 'CTRL', 'CTRL_L': 'L-CTRL', 'CTRL_R': 'R-CTRL',
            'ALT': 'ALT', 'ALT_L': 'L-ALT', 'ALT_R': 'R-ALT', 'ALT_GR': 'ALT GR',
            'UP': '↑', 'DOWN': '↓', 'LEFT': '←', 'RIGHT': '→',
            'DELETE': 'DEL', 'INSERT': 'INS', 'HOME': 'HOME', 'END': 'END',
            'PAGE_UP': 'PG UP', 'PAGE_DOWN': 'PG DN', 'ESC': 'ESC', 'ESCAPE': 'ESC',
        }
        
        if display_name in display_map:
            display_name = display_map[display_name]
